  ...
  class ChalkBoardController {
    ...
    $onInit() {
      ...
      function chalkboard(){
        $('#chalkboard').remove();
        $('.chalk').remove();
        $('#ChalkBoardState').prepend('<canvas id="chalkboard"></canvas>');
        $('ChalkBoardState').prepend('<div class="chalk"></div>');

        var canvas = document.getElementById("chalkboard");
        $('#chalkboard').css('width', 300);
        $('#chalkboard').css('height', 300);
        canvas.width = 300;
        canvas.height = 300;
